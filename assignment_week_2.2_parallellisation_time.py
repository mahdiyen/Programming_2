...
def article_details_without_mp(reference=references[0:9]):
    """
    Fetches the XML data of multiple PubMed articles sequentially without using multiprocessing.
...
if __name__ == '__main__':
    ...
    article_details_without_mp(reference=references[0:9])
    end_time = time.time()
    execution_time = end_time - start_time
    print("Execution time without multiprocessing:", execution_time, "seconds")
